...
この震声（しんせいと読みます）では緊急地震速報、過去10件の地震履歴、各地の観測点の揺れの大きさを見ることができます。緊急地震速報は通常のEEWに加え震源が150km以上の深発地震や、plum法やレベル法のような仮定震源要素を含む緊急地震速報、またキャンセル報も見れます。また、一般向けの緊急地震速報（警報）のほかにも高度利用者向けの緊急地震速報（予報）も受信します。また、これらは設定で変更することができます
...
n報:
速報:地震内容が何報目なのか、最終報の場合は「最終」　履歴:常に空白が返ってくる
